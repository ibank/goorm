	...
	signup : function(postdata, mode) {
		...
		$.post("/auth/signup?mode="+mode, postdata, function(signup_result){
			if(signup_result.type == 'signup'){
				...
				if(!signup_result.data.result) self.toast_error_message(signup_result.data);
			}
		});
	},
	
	toast_error_message : function(result){
		// $("#login_message").empty();
		switch(result.code){
			case 0:
			...
			case 1:
				...
				core.module.toast.show(core.module.localization.msg['alert_user_unfit_reg_id']);
				break;
			case 2:
				// $("#login_message").append('<div class="signup_error_message">'+core.module.localization.msg['alert_sigup_duplicate_id']+'</div>');
				core.module.toast.show(core.module.localization.msg['alert_user_duplicate_id']);
				break;
			case 3:
				// $("#login_message").append('<div class="signup_error_message">'+core.module.localization.msg['alert_sigup_duplicate_id']+'</div>');
				core.module.toast.show(core.module.localization.msg['alert_user_not_found_id']);
				break;
			case 4:
				// $("#login_message").append('<div class="signup_error_message">'+core.module.localization.msg['alert_sigup_duplicate_id']+'</div>');
				core.module.toast.show(core.module.localization.msg['alert_user_unmatched_id']);
				break;
			case 10:
			...
			case 11:
				...
				core.module.toast.show(core.module.localization.msg['alert_user_undefined_re_password']);
				break;
			case 12:
