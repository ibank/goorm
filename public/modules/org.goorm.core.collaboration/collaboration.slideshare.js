...
org.goorm.core.collaboration.slideshare.prototype = {
	...
	init: function(){
		...
		$("#slide_body").append("<div id='slide_url' class='layout_right_slide_tab'>URL <input id='slideshare_url' type='text' value='http://www.slideshare.net/jeg0330/goorm-15035830'/></div><div id='slide_control'><button id='slide_prev'><img src='images/icons/context/prev.png' style='margin-top:3px;' /></button><button id='slideshare_presentation'><img src='images/icons/context/play.png' style='margin-top:3px;' /></button><button id='slide_next'><img src='images/icons/context/next.png' style='margin-top:3px;' /></button></div><iframe id='iframe_slideshare' src='http://"+document.location.host+"/lib/slideshare/slide.html' width='100%' frameborder=0 marginwidth=0 marginheight=0 scrolling=no allowfullscreen> </iframe>");
