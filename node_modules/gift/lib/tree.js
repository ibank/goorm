(function() {
  ...
  module.exports = Tree = (function() {
    ...
    Tree.prototype.contents = function(callback) {
      var _this = this;
      if (this._contents) return callback(null, this._contents);
      return this.repo.git("ls-tree", {}, this.id, function(err, stdout, stderr) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          line = _ref[_i];
          if (line) _this._contents.push(_this.content_from_string(line));
        }
      ...
      if (/\//.test(file)) {
        ...
        return this.trees(function(err, _trees) {
          ...
          for (_i = 0, _len = _trees.length; _i < _len; _i++) {
            tree = _trees[_i];
            if (tree.name === dir) return callback(rest, callback);
          }
        ...
        return this.contents(function(err, children) {
          ...
          for (_i = 0, _len = children.length; _i < _len; _i++) {
            child = children[_i];
            if (child.name === file) return callback(null, child);
          }
          return callback(null, null);
        });
      }
